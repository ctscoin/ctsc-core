...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CTSC features */
        {"ctsc", "masternode", &masternode, true, true, false},
        {"ctsc", "listmasternodes", &listmasternodes, true, true, false},
        {"ctsc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ctsc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ctsc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ctsc", "masternodedebug", &masternodedebug, true, true, false},
        {"ctsc", "startmasternode", &startmasternode, true, true, false},
        {"ctsc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ctsc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ctsc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ctsc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ctsc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ctsc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ctsc", "mnbudget", &mnbudget, true, true, false},
        {"ctsc", "preparebudget", &preparebudget, true, true, false},
        {"ctsc", "submitbudget", &submitbudget, true, true, false},
        {"ctsc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ctsc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ctsc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ctsc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ctsc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ctsc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ctsc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ctsc", "checkbudgets", &checkbudgets, true, true, false},
        {"ctsc", "mnsync", &mnsync, true, true, false},
        {"ctsc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> ctsc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51526/\n";
}
