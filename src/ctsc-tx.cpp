...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CTSC Core ctsc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ctsc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ctsc transaction") + "\n" +
                               "  ctsc-tx [options] -create [commands]   " + _("Create hex-encoded ctsc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ctsc transaction
