...
int nStakeTargetSpacing = 60; // CTSC: 1 minute blocks during POS (block 501+)
...
{
    // CTSC will hash in the transaction hash and the index number in order to make sure each hash is unique
