...
This issue tracker is only for technical issues related to CTSC Core.
General CTSC questions and/or support requests and are best directed to the [CTSC Discord](https://discord.gg/vB9KgNc).
...
### What version of CTSC Core are you using?
