...
Intro
-----
CTSC (CTSC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. CTSC utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run ctsc-qt.exe.

CTSC Core is the original CTSC client and it builds the backbone of the network.
However, it downloads and stores the entire history of CTSC transactions;
