...
In order to support loading of multiple wallets in ctsc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ctsc.cpp.
...
Changes to ctsc.cpp
----------------------
ctsc.cpp is the entry point into ctsc-qt, and as such, will require some minor modifications to provide hooks for
