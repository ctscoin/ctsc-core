Contributing to CTSC Core
==================================

The CTSC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CTSC Core project, and is not to be
confused with overall CTSC Network Protocol consensus changes.

Whether a pull request is merged into CTSC Core rests with the project merge
...
Patches that change CTSC consensus rules are considerably more involved than
...
Where a patch set proposes to change the CTSC consensus, it must have been
...
The project leader is the release manager for each CTSC Core release.
