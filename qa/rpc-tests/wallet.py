...
#   c) node1 mines 32 blocks, so now node 0 has 500000CTS, node 1 has 4250CTS, node2 has none.
#   d) node0 sends 601 CTSC to node2, in two transactions (301 CTSC, then 300 CTSC).
