...
RESOURCES += src/qt/ctsc.qrc src/qt/ctsc_locale.qrc

TRANSLATIONS += src/qt/locale/ctsc_bg.ts \
                src/qt/locale/ctsc_de.ts \
                src/qt/locale/ctsc_en.ts \
                src/qt/locale/ctsc_es.ts \
                src/qt/locale/ctsc_fi.ts \
                src/qt/locale/ctsc_fr.ts \
                src/qt/locale/ctsc_it.ts \
                src/qt/locale/ctsc_ja.ts \
                src/qt/locale/ctsc_pl.ts \
                src/qt/locale/ctsc_pt.ts \
                src/qt/locale/ctsc_ru.ts \
                src/qt/locale/ctsc_sk.ts \
                src/qt/locale/ctsc_sv.ts \
                src/qt/locale/ctsc_vi.ts \
                src/qt/locale/ctsc_zh_CN.ts \
                src/qt/locale/ctsc_zh_TW.ts
